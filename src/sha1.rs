...
mod tests {
    ...
    fn test_sha1() {
        assert_eq!(
            super::sha1(b"hello"),
            [
                0xaa, 0xf4, 0xc6, 0x1d, 0xdc, 0xc5, 0xe8, 0xa2, 0xda, 0xbe, 0xde, 0xf, 0x3b, 0x48,
    ...
    fn test_hmac_sha1() {
        assert_eq!(
            super::hmac_sha1(b"hello", b"hello"),
            [
                0x9a, 0xde, 0x18, 0xf3, 0xe0, 0xee, 0x81, 0xa5, 0x34, 0x3f, 0x4a, 0x0, 0x5f, 0x79,
                0x5d, 0xba, 0xf9, 0xce, 0xef, 0xd8
            ]
        );
    }
}
